...
void StyleFactory::InitMetadata()
{
    ...
    DEFINE_METADATA(StylePropertyId_BorderWidth, false, Thickness());
    ...
    DEFINE_METADATA(StylePropertyId_BorderRadius, false, Thickness());
...
void StyleFactory::ParseProperty(Style* style, const std::string& name, const std::string& value)
{
    ...
    {
        float w = ParseSize(value).ToPixels();
        Thickness t = Thickness(w, w, w, w);
        style->Set(StylePropertyId_BorderWidth, Box(t));
    }
    else if (name == "border-radius")
    {
        float w = ParseSize(value).ToPixels();
        Thickness r = Thickness(w, w, w, w);
        style->Set(StylePropertyId_BorderRadius, Box(r));
    }
    else if (name == "cursor")
    {
